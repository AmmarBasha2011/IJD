...
from .SQL.full_text_search import full_text_search, search_with_scoring
from .SQL.geospatial import haversine, find_nearby
from .SQL.timeseries import get_time_range, resample_data
from .SQL.relationships import define_relationship, get_related_records
from .websocket_sync import (
    connected_clients, broadcast, handle_client, start_sync_server, notify_change
)
setupAllThings()
...
__uri__ = __url__
__doc__ = __doc__
__description__ = "A JSON SQL-like database library with full-text search, geospatial, time series, relationships, WebSockets, and all previous features!"
