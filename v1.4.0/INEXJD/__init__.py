...
from .SQL.migrations import get_current_version, set_current_version, create_migration, apply_migration, add_column, drop_column, rename_column
...
__uri__ = __url__
__doc__ = __doc__
__description__ = "A JSON SQL-like database library with ORM, SQL queries, CLI, web GUI, logging, and all previous features!"
